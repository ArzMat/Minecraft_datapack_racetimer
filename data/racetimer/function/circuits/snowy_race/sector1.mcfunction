# Record time
execute store result score @s sector1_time run time query gametime
scoreboard players operation @s tempo = @s sector1_time
scoreboard players operation @s tempo -= @s start_time
...
# Check personal best
execute unless score @s pb_s1_snowy_race matches 1.. run scoreboard players set @s pb_s1_snowy_race 999999
execute if score @s tempo < @s pb_s1_snowy_race run scoreboard players set #is_pb costanti 1

# Check world record
execute store result score wr_time costanti run data get storage racetimer:snowy_race records.s1
execute if score @s tempo < wr_time costanti run scoreboard players set #is_wr costanti 1

# === SALVA VECCHIO WR PER CONFRONTO ===
execute if score #is_wr costanti matches 1 store result score old_wr costanti run data get storage racetimer:snowy_race records.s1
...
execute if score #is_wr costanti matches 1 run scoreboard players operation @s tempo = @s sector1_time
execute if score #is_wr costanti matches 1 run scoreboard players operation @s tempo -= @s start_time
execute if score #is_wr costanti matches 1 run function racetimer:core/calculate_time

# Salva il nuovo WR
execute if score #is_wr costanti matches 1 store result storage racetimer:snowy_race records.s1 int 1 run scoreboard players get @s tempo
execute if score #is_wr costanti matches 1 as @s run function racetimer:core/save_player_name
execute if score #is_wr costanti matches 1 run data modify storage racetimer:snowy_race records.s1_player set from storage racetimer:temp player_name

# === SALVA VECCHIO PB PER CONFRONTO ===
execute if score #is_pb costanti matches 1 run scoreboard players operation old_pb costanti = @s pb_s1_snowy_race
...
execute if score #is_pb costanti matches 1 run scoreboard players operation @s tempo = @s sector1_time
execute if score #is_pb costanti matches 1 run scoreboard players operation @s tempo -= @s start_time
execute if score #is_pb costanti matches 1 run function racetimer:core/calculate_time

# Aggiorna il PB
execute if score #is_pb costanti matches 1 run scoreboard players operation @s pb_s1_snowy_race = @s tempo

# === DISPLAY CON CONFRONTO ===
# WR con vecchio record
execute if score #is_wr costanti matches 1 if score old_wr costanti matches 999999 run tellraw @a ["",{"selector":"@s"},{"text":" - Settore 1: ","color":"yellow","bold":true},{"score":{"name":"@s","objective":"minuti"},"color":"light_purple","bold":true},{"text":":","color":"light_purple","bold":true},{"score":{"name":"@s","objective":"sec_decine"},"color":"light_purple","bold":true},{"score":{"name":"@s","objective":"sec_unita"},"color":"light_purple","bold":true},{"text":".","color":"light_purple","bold":true},{"score":{"name":"@s","objective":"cent_decine"},"color":"light_purple","bold":true},{"score":{"name":"@s","objective":"cent_unita"},"color":"light_purple","bold":true},{"text":" WR!","color":"light_purple","bold":true}]
...
# PB con vecchio record (solo se non è WR)
execute if score #is_wr costanti matches 0 if score #is_pb costanti matches 1 if score old_pb costanti matches 999999 run tellraw @a ["",{"selector":"@s"},{"text":" - Settore 1: ","color":"yellow","bold":true},{"score":{"name":"@s","objective":"minuti"},"color":"green","bold":true},{"text":":","color":"green","bold":true},{"score":{"name":"@s","objective":"sec_decine"},"color":"green","bold":true},{"score":{"name":"@s","objective":"sec_unita"},"color":"green","bold":true},{"text":".","color":"green","bold":true},{"score":{"name":"@s","objective":"cent_decine"},"color":"green","bold":true},{"score":{"name":"@s","objective":"cent_unita"},"color":"green","bold":true}]
...
# Tempo normale
execute if score #is_pb costanti matches 0 if score #is_wr costanti matches 0 run tellraw @a ["",{"selector":"@s"},{"text":" - Settore 1: ","color":"yellow","bold":true},{"score":{"name":"@s","objective":"minuti"},"color":"yellow","bold":true},{"text":":","color":"yellow","bold":true},{"score":{"name":"@s","objective":"sec_decine"},"color":"yellow","bold":true},{"score":{"name":"@s","objective":"sec_unita"},"color":"yellow","bold":true},{"text":".","color":"yellow","bold":true},{"score":{"name":"@s","objective":"cent_decine"},"color":"yellow","bold":true},{"score":{"name":"@s","objective":"cent_unita"},"color":"yellow","bold":true}]

# Salva il colore del settore completato
execute if score #is_wr costanti matches 1 run scoreboard players set @s s1_color 3
execute if score #is_wr costanti matches 0 if score #is_pb costanti matches 1 run scoreboard players set @s s1_color 2
execute if score #is_wr costanti matches 0 if score #is_pb costanti matches 0 run scoreboard players set @s s1_color 1

# Update tags
tag @s add settore1_snowy_race