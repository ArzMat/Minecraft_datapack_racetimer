# === SETTORE 5 ===
# Record sector 5 time
execute store result score @s sector5_time run time query gametime
scoreboard players operation @s tempo = @s sector5_time
scoreboard players operation @s tempo -= @s sector4_time

# Calculate sector 5 time components
function racetimer:core/calculate_time

# Check sector 5 records
scoreboard players set #is_pb costanti 0
scoreboard players set #is_wr costanti 0

execute unless score @s pb_s5_snowy_race matches 1.. run scoreboard players set @s pb_s5_snowy_race 999999
execute if score @s tempo < @s pb_s5_snowy_race run scoreboard players set #is_pb costanti 1

execute store result score #wr_time costanti run data get storage racetimer:snowy_race records.s5
execute if score @s tempo < #wr_time costanti run scoreboard players set #is_wr costanti 1

# === SALVA VECCHIO WR S5 PER CONFRONTO ===
execute if score #is_wr costanti matches 1 store result score #old_wr costanti run data get storage racetimer:snowy_race records.s5
...
# Ripristina il tempo attuale S5
execute if score #is_wr costanti matches 1 run scoreboard players operation @s tempo = @s sector5_time
execute if score #is_wr costanti matches 1 run scoreboard players operation @s tempo -= @s sector4_time
execute if score #is_wr costanti matches 1 run function racetimer:core/calculate_time

execute if score #is_wr costanti matches 1 store result storage racetimer:snowy_race records.s5 int 1 run scoreboard players get @s tempo
execute if score #is_wr costanti matches 1 as @s run function racetimer:core/save_player_name
execute if score #is_wr costanti matches 1 run data modify storage racetimer:snowy_race records.s5_player set from storage racetimer:temp player_name

# === SALVA VECCHIO PB S5 PER CONFRONTO ===
execute if score #is_pb costanti matches 1 run scoreboard players operation old_pb costanti = @s pb_s5_snowy_race
...
# Ripristina tempo attuale S5
execute if score #is_pb costanti matches 1 run scoreboard players operation @s tempo = @s sector5_time
execute if score #is_pb costanti matches 1 run scoreboard players operation @s tempo -= @s sector4_time
execute if score #is_pb costanti matches 1 run function racetimer:core/calculate_time

# Aggiorna il PB S5
execute if score #is_pb costanti matches 1 run scoreboard players operation @s pb_s5_snowy_race = @s tempo

# === DISPLAY SETTORE 5 CON CONFRONTO ===
# WR con vecchio record
execute if score #is_wr costanti matches 1 if score old_wr costanti matches 999999 run tellraw @a ["",{"selector":"@s"},{"text":" - Settore 5: ","color":"yellow","bold":true},{"score":{"name":"@s","objective":"minuti"},"color":"light_purple","bold":true},{"text":":","color":"light_purple","bold":true},{"score":{"name":"@s","objective":"sec_decine"},"color":"light_purple","bold":true},{"score":{"name":"@s","objective":"sec_unita"},"color":"light_purple","bold":true},{"text":".","color":"light_purple","bold":true},{"score":{"name":"@s","objective":"cent_decine"},"color":"light_purple","bold":true},{"score":{"name":"@s","objective":"cent_unita"},"color":"light_purple","bold":true},{"text":" WR!","color":"light_purple","bold":true}]
...
# Tempo normale
execute if score #is_pb costanti matches 0 if score #is_wr costanti matches 0 run tellraw @a ["",{"selector":"@s"},{"text":" - Settore 5: ","color":"yellow","bold":true},{"score":{"name":"@s","objective":"minuti"},"color":"yellow","bold":true},{"text":":","color":"yellow","bold":true},{"score":{"name":"@s","objective":"sec_decine"},"color":"yellow","bold":true},{"score":{"name":"@s","objective":"sec_unita"},"color":"yellow","bold":true},{"text":".","color":"yellow","bold":true},{"score":{"name":"@s","objective":"cent_decine"},"color":"yellow","bold":true},{"score":{"name":"@s","objective":"cent_unita"},"color":"yellow","bold":true}]

# Salva colore S5
execute if score #is_wr costanti matches 1 run scoreboard players set @s s5_color 3
execute if score #is_wr costanti matches 0 if score #is_pb costanti matches 1 run scoreboard players set @s s5_color 2
execute if score #is_wr costanti matches 0 if score #is_pb costanti matches 0 run scoreboard players set @s s5_color 1

# === TEMPO TOTALE ===
# Calculate total time
scoreboard players operation @s total_time = @s sector5_time
...
execute unless score @s pb_total_snowy_race matches 1.. run scoreboard players set @s pb_total_snowy_race 999999
execute if score @s tempo < @s pb_total_snowy_race run scoreboard players set #is_pb costanti 1

execute store result score wr_time costanti run data get storage racetimer:snowy_race records.total
execute if score @s tempo < wr_time costanti run scoreboard players set #is_wr costanti 1

# === SALVA VECCHIO WR TOTALE PER CONFRONTO ===
execute if score #is_wr costanti matches 1 store result score old_wr_tot costanti run data get storage racetimer:snowy_race records.total
...
execute if score #is_wr costanti matches 1 store result storage racetimer:snowy_race records.total int 1 run scoreboard players get @s tempo
execute if score #is_wr costanti matches 1 as @s run function racetimer:core/save_player_name
execute if score #is_wr costanti matches 1 run data modify storage racetimer:snowy_race records.total_player set from storage racetimer:temp player_name

# === SALVA VECCHIO PB TOTALE PER CONFRONTO ===
execute if score #is_pb costanti matches 1 run scoreboard players operation old_pb_tot costanti = @s pb_total_snowy_race
...
execute if score #is_pb costanti matches 1 run scoreboard players operation @s pb_total_snowy_race = @s tempo
...
# Reset tags
tag @s remove settore4_snowy_race
tag @s remove partito_snowy_race