# circuits/snowy_race/dashboard/update_dynamic.mcfunction
...
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 1 run bossbar set racetimer:player_1 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 2 run bossbar set racetimer:player_2 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 3 run bossbar set racetimer:player_3 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 4 run bossbar set racetimer:player_4 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 5 run bossbar set racetimer:player_5 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 6 run bossbar set racetimer:player_6 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 7 run bossbar set racetimer:player_7 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 8 run bossbar set racetimer:player_8 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 9 run bossbar set racetimer:player_9 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 10 run bossbar set racetimer:player_10 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 11 run bossbar set racetimer:player_11 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 12 run bossbar set racetimer:player_12 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 13 run bossbar set racetimer:player_13 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 14 run bossbar set racetimer:player_14 color green
execute if score #live_sector costanti <= @s pb_s1_snowy_race if entity @s[tag=!settore1_snowy_race] if score @s player_bossbar_id matches 15 run bossbar set racetimer:player_15 color green

execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 1 run bossbar set racetimer:player_1 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 2 run bossbar set racetimer:player_2 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 3 run bossbar set racetimer:player_3 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 4 run bossbar set racetimer:player_4 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 5 run bossbar set racetimer:player_5 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 6 run bossbar set racetimer:player_6 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 7 run bossbar set racetimer:player_7 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 8 run bossbar set racetimer:player_8 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 9 run bossbar set racetimer:player_9 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 10 run bossbar set racetimer:player_10 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 11 run bossbar set racetimer:player_11 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 12 run bossbar set racetimer:player_12 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 13 run bossbar set racetimer:player_13 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 14 run bossbar set racetimer:player_14 color green
execute if score #live_sector costanti <= @s pb_s2_snowy_race if entity @s[tag=settore1_snowy_race,tag=!settore2_snowy_race] if score @s player_bossbar_id matches 15 run bossbar set racetimer:player_15 color green

execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 1 run bossbar set racetimer:player_1 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 2 run bossbar set racetimer:player_2 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 3 run bossbar set racetimer:player_3 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 4 run bossbar set racetimer:player_4 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 5 run bossbar set racetimer:player_5 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 6 run bossbar set racetimer:player_6 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 7 run bossbar set racetimer:player_7 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 8 run bossbar set racetimer:player_8 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 9 run bossbar set racetimer:player_9 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 10 run bossbar set racetimer:player_10 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 11 run bossbar set racetimer:player_11 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 12 run bossbar set racetimer:player_12 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 13 run bossbar set racetimer:player_13 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 14 run bossbar set racetimer:player_14 color green
execute if score #live_sector costanti <= @s pb_s3_snowy_race if entity @s[tag=settore2_snowy_race,tag=!settore3_snowy_race] if score @s player_bossbar_id matches 15 run bossbar set racetimer:player_15 color green

execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 1 run bossbar set racetimer:player_1 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 2 run bossbar set racetimer:player_2 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 3 run bossbar set racetimer:player_3 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 4 run bossbar set racetimer:player_4 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 5 run bossbar set racetimer:player_5 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 6 run bossbar set racetimer:player_6 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 7 run bossbar set racetimer:player_7 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 8 run bossbar set racetimer:player_8 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 9 run bossbar set racetimer:player_9 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 10 run bossbar set racetimer:player_10 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 11 run bossbar set racetimer:player_11 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 12 run bossbar set racetimer:player_12 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 13 run bossbar set racetimer:player_13 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 14 run bossbar set racetimer:player_14 color green
execute if score #live_sector costanti <= @s pb_s4_snowy_race if entity @s[tag=settore3_snowy_race,tag=!settore4_snowy_race] if score @s player_bossbar_id matches 15 run bossbar set racetimer:player_15 color green

execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 1 run bossbar set racetimer:player_1 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 2 run bossbar set racetimer:player_2 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 3 run bossbar set racetimer:player_3 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 4 run bossbar set racetimer:player_4 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 5 run bossbar set racetimer:player_5 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 6 run bossbar set racetimer:player_6 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 7 run bossbar set racetimer:player_7 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 8 run bossbar set racetimer:player_8 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 9 run bossbar set racetimer:player_9 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 10 run bossbar set racetimer:player_10 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 11 run bossbar set racetimer:player_11 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 12 run bossbar set racetimer:player_12 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 13 run bossbar set racetimer:player_13 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 14 run bossbar set racetimer:player_14 color green
execute if score #live_sector costanti <= @s pb_s5_snowy_race if entity @s[tag=settore4_snowy_race] if score @s player_bossbar_id matches 15 run bossbar set racetimer:player_15 color green
