...
execute if score #live_sector costanti <= @s pb_s1_deserto if entity @s[tag=!settore1_deserto] run scoreboard players set #color_type costanti 2
execute if score #live_sector costanti <= @s pb_s2_deserto if entity @s[tag=settore1_deserto,tag=!settore2_deserto] run scoreboard players set #color_type costanti 2
execute if score #live_sector costanti <= @s pb_s3_deserto if entity @s[tag=settore2_deserto,tag=!settore3_deserto] run scoreboard players set #color_type costanti 2
execute if score #live_sector costanti <= @s pb_s4_deserto if entity @s[tag=settore3_deserto] run scoreboard players set #color_type costanti 2
...
function racetimer:core/bossbar_pool/set_name_deserto